                ...
                <div>
                    <div className="p-4 pt-16 md:p-16 flex flex-col items-start md:sticky md:top-26">
                        <SectionTitle
                            ...
                            icon={SparkleIcon}
                            title="Core features"
                            subtitle="Everything you need to discover, exchange and share books with a vibrant reading community - designed for book lovers."
                        />
                        <AnimatedContent className="p-4 md:p-6 bg-orange-500 w-full rounded-xl mt-12">
                            <p className="text-lg text-white">
                                Trusted by thousands of readers building their personal libraries through community exchange.
                            </p>

                            <a href="/books" className="bg-white w-max hover:bg-gray-100 px-5 py-2 rounded-full mt-6 flex items-center gap-1" >
                                Explore Books
