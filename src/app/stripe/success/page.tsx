...
function StripeSuccessContent() {
  ...
  useEffect(() => {
    ...
    processPayment()
  }, [sessionId, points, updateSession, router]) // Include all dependencies
      ...
      <div className="max-w-md w-full">
        <div className="bg-white border border-zinc-200 rounded-2xl shadow-xl p-8 text-center">
          ...
          <div className="flex gap-3 justify-center flex-wrap">
            ...
            <Link
              href="/books"
              className="inline-block px-6 py-3 bg-zinc-200 text-zinc-900 font-medium rounded-lg hover:bg-zinc-300 transition-colors"
            >
              Browse Books
            </Link>
            <Link
